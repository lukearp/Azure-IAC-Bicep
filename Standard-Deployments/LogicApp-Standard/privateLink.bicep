...
module logicAppPrivateLink '../../Modules/Microsoft.Network/privateEndpoints/privateEndpoints.bicep' = if(aseId != '') {
...
module logicAppPrivateLinkDns '../../Modules/Microsoft.Network/privateDnsZones/privateDnsZones.bicep' = if(aseId != '') {
